...
void DepthCallback(const sensor_msgs::ImageConstPtr& msg)
{   
    cout << " Depth call back error " << endl;
...
{ 
    ...
    {   
        ...
        {
            //int answer = 0;
            //answer = GetPose("orange", orange_synthetic, orange_array); 
            if(GetPose("orange", orange_synthetic, orange_array) == 0)
            {
                //ros::NodeHandle nh_;//("Color_Matrix");

                //ros::Publisher pub = nh_.advertise<std_msgs::Float64MultiArray>("Orange_Matrix", 5);
                std_msgs::Float64MultiArray msg;
                msg.data.resize(16);
    ...
    {   
        ...
        {
            //int answer = 0;
            //answer = GetPose("yellow", yellow_synthetic, yellow_array); 
            if(GetPose("yellow", yellow_synthetic, yellow_array) == 0)
            {   
                //ros::NodeHandle nh_;//("Color_Matrix");

                //ros::Publisher pub = nh_.advertise<std_msgs::Float64MultiArray>("Yellow_Matrix", 5);
                std_msgs::Float64MultiArray msg;
                msg.data.resize(16);
    ...
    { 
        ...
        {
            //int answer = 0;
            //answer = GetPose("green", green_synthetic, green_array); 
    ...
    {   
        ...
        {
            //int answer = 0;
            //answer = GetPose("blue", blue_synthetic, blue_array); 
            if(GetPose("blue", blue_synthetic, blue_array) == 0)
            {
                //ros::NodeHandle nh_;

                //ros::Publisher pub = nh_.advertise<std_msgs::Float64MultiArray>("Blue_Matrix", 5);
                std_msgs::Float64MultiArray msg;
                msg.data.resize(16);
    ...
    {   
        ...
        {
            //int answer = 0;
            //answer = GetPose("purple", purple_synthetic, purple_array); 
            if(GetPose("purple", purple_synthetic, purple_array) == 0 && purple_array.size() == 16)
            {
                //ros::NodeHandle nh_;

                //ros::Publisher pub = nh_.advertise<std_msgs::Float64MultiArray>("Purple_Matrix", 5);
                std_msgs::Float64MultiArray msg;
                msg.data.resize(16);
    ...
    { 
        ...
        {
            //int answer = 0;
            //answer = GetPose("brown", brown_synthetic, brown_array); 
            if((GetPose("brown", brown_synthetic, brown_array)) == 0)
            {   
                //ros::NodeHandle nh_;//("Color_Matrix");


                //ros::Publisher pub = nh_.advertise<std_msgs::Float64MultiArray>("Brown_Matrix", 100);
                std_msgs::Float64MultiArray msg;
                msg.data.resize(16);
    ...
    {   
        ...
        if(height_step == 2)
        {
            ...
            if(Red_CheckDist(vector, red_cloud, point_one, point_two))
                { dier = point_one; diyi = point_two; cout << " I'm from true, I'm red " << endl << endl; }
            else
                { dier = point_two; diyi = point_one; cout << " I'm from true, I'm red " << endl << endl; }
...
pcl::PointCloud<pcl::PointXYZ> GetBrownSynthetic()
{
    ...
    {   
        ...
        cout << "diyi point one: " << diyi_one << endl;
        cout << "diyi point two: " << diyi_two << endl;
...
{   
    ...
    *target_ptr = target;
    ...
    align.setMaxCorrespondenceDistance (1); // Inlier threshold
    ...
    */
    ...
    //CloudViewer(target_ptr, source_ptr);
    //CloudViewer(target_ptr, final);
